...
import com.github.smallinger.redefinedpipes.network.message.ItemTransportMessage;
...
public class ItemPipe extends Pipe {
    public static final ResourceLocation ID = ResourceLocation.fromNamespaceAndPath(RedefinedPipes.MOD_ID, "item");
    ...
    public void sendTransportUpdate() {
        ...
        RedefinedPipesNetwork.sendInArea(level, pos, 32, new ItemTransportMessage(pos, props));
    }
