...
public enum ItemPipeType {
    ...
    public ResourceLocation getId() {
        switch (this) {
            case BASIC:
                return ResourceLocation.fromNamespaceAndPath(RedefinedPipes.MOD_ID, "basic_item_pipe");
            case IMPROVED:
                return ResourceLocation.fromNamespaceAndPath(RedefinedPipes.MOD_ID, "improved_item_pipe");
            case ADVANCED:
                return ResourceLocation.fromNamespaceAndPath(RedefinedPipes.MOD_ID, "advanced_item_pipe");
            default:
                throw new RuntimeException("Unknown ItemPipeType: " + this);
        }
    }
    ...
    public ResourceLocation getNetworkType() {
        return ResourceLocation.fromNamespaceAndPath(RedefinedPipes.MOD_ID, "item_" + name().toLowerCase());
    }
} 