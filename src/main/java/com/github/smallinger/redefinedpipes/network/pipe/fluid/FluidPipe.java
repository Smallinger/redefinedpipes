...
public class FluidPipe extends Pipe {
    public static final ResourceLocation ID = ResourceLocation.fromNamespaceAndPath(RedefinedPipes.MOD_ID, "fluid");
    ...
    public void sendFluidPipeUpdate() {
        ...
        // RedefinedPipes.NETWORK.sendInArea(level, pos, 32, new FluidPipeMessage(pos, ((FluidNetwork) network).getFluidTank().getFluid(), getFullness()));
    }
